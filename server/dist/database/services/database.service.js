...
const connectDb = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const uniqueIdentifierCounterCollection = db.collection(process.env.UNIQUE_IDENTIFIER_COUNTER_COLLECTION_NAME);
    ingredientsCollection.createIndex({ name: 1 }, { unique: true });
    exports.collections.ingredients = ingredientsCollection;
    exports.collections.uniqueIdentifierCounter = uniqueIdentifierCounterCollection;
